...
function [modelParameters] = positionEstimatorTraining(training_data)
    ...
    %creates model from bagging (usining 50 trees)
    classificationMdl = TreeBagger( 50 , classificationData(:,2:end) , classificationData(:,1) , 'Method' , 'Classification' );
    
    %stores data in structure
    modelParameters.Classification = classificationMdl;
